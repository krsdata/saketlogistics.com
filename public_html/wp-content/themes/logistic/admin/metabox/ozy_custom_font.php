...
return array(
	...
	'template'    => array(
		...
		array(
			...
			'repeating' => true,
			'length'    => 1,
			'name'      => 'ozy_logistic_meta_font_group',
			'title'     => __('Custom Font', 'vp_textdomain'),
			'fields'    => array(	
				array(
					'type' => 'textbox',
					'name' => 'ozy_logistic_meta_font_id',
				...
				array(
					'type' => 'upload',
					'name' => 'ozy_logistic_meta_font_eot',
				...
				array(
					'type' => 'upload',
					'name' => 'ozy_logistic_meta_font_woff',
				...
				array(
					'type' => 'upload',
					'name' => 'ozy_logistic_meta_font_ttf',
				...
				array(
					'type' => 'upload',
					'name' => 'ozy_logistic_meta_font_svg',
				...
				array(
					'type' => 'radiobutton',
					'name' => 'ozy_logistic_meta_font_weight',
				...
				array(
					'type' => 'radiobutton',
					'name' => 'ozy_logistic_meta_font_style',
