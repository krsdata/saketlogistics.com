...
if( !function_exists( 'ozy_logistic_style') ) :
	...
	?>
		...
		<?php
			...
			$top_smal_menu_height = 0;//30; //check if top small menu available
			if(is_page_template('page-countdown.php') || is_page_template('404.php') || is_404()) {
				echo '#main{margin-top:0!important}';
			}else{
				echo '@media only screen and (min-width: 1025px) {#main{margin-top:'. (ozy_get_option('primary_menu_height')+$top_smal_menu_height) .'px;}}';
			}
