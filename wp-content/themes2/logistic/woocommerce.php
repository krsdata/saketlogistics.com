...
?>
	<div id="sidebar" class="<?php echo esc_attr($ozy_data->_woocommerce_content_css_name); ?>">
		<ul>
...
?>
<div id="content" class="<?php echo esc_attr($ozy_data->_woocommerce_content_css_name); ?>">
