...
class OZY_Filedownload_Widget extends WP_Widget {
	...
	function OZY_Filedownload_Widget() {
		...
		$this->WP_Widget( 'filedownload-widget', __('(Logistic) File Download Box', 'vp_textdomain'), $widget_ops, $control_ops );
	}
...
class OZY_Testimonial_Widget extends WP_Widget {
	...
	function OZY_Testimonial_Widget() {
		...
		$this->WP_Widget( 'testimonial-widget', __('(Logistic) Testimonial Box', 'vp_textdomain'), $widget_ops, $control_ops );
	}
...
class OZY_CustomMenu_Widget extends WP_Widget {
	...
	function OZY_CustomMenu_Widget() {
		...
		$this->WP_Widget( 'custommenu-widget', __('(Logistic) Custom Menu', 'vp_textdomain'), $widget_ops, $control_ops );
	}
...
class OZY_LatestPosts_Widget extends WP_Widget {
	...
	function OZY_LatestPosts_Widget() {
		...
		$this->WP_Widget( 'latestposts-widget', __('(Logistic) Latest Posts', 'vp_textdomain'), $widget_ops, $control_ops );
	}
...
class OZY_Flickr_Widget extends WP_Widget {
	function OZY_Flickr_Widget() {
		$this->WP_Widget('flickr_widget', '(Logistic) Flickr Widget', array('classname' => 'flickr', 'description' => __('(Logistic) Flickr Widget for user photo stream!', 'vp_textdomain')), array('id_base' => 'flickr_widget'));
		}
