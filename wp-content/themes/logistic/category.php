            	...
            	<div class="vc_col-sm-12 wpb_column vc_column_container">
                	<div class="wpb_wrapper">
						...
						<?php
                            ...
                            if($hide_title) {
								echo '<div class="post-excerpt-'. esc_attr($ozy_current_post_format) .' simple-post-format" style="'. (isset($thumbnail_image_src[0]) ? 'background-image:url('. esc_attr($thumbnail_image_src[0]) .');':'' ) .'">
										<div>
