...
class Menu_Item_Custom_Fields_Edit_Style {
	...
	public static function _fields( $item, $depth, $args = array(), $id = 0 ) {
		?>
			<p class="field-custom description description-wide">
				<label for="edit-menu-item-style-<?php echo esc_attr( $item->ID ) ?>"><?php _e( 'Menu Item Options', 'vp_textdomain' ) ?><br />
					<?php printf(
						'<input type="button" value="'. __('Edit Options', 'vp_textdomain') .'" name="menu-item-edit-style[%2$d]" class="widefat code edit-menu-item-edit-style" id="edit-menu-edit-style-%2$d">
						<textarea style="display:none;" name="menu-item-style[%2$d]" class="widefat code edit-menu-item-style" id="edit-menu-item-style-%2$d">%1$s</textarea><i>Style your menu item individualy by this option</i>',
	...
	public static function _columns( $columns ) {
		$columns['custom_mega_menu_style'] = __( 'Custom Menu Options', 'vp_textdomain' );
