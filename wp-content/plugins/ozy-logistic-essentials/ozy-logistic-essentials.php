...
if(is_plugin_active("js_composer/js_composer.php") && function_exists('wpb_map') && function_exists('vc_set_as_theme')) {
	...
	add_shortcode_param('select_an_icon', 'ozy_select_an_icon_settings_field', get_template_directory_uri() .'/scripts/admin/admin.js');
	...
	*/
	if (!function_exists('ozy_vc_fancytab_wrapper')) {
		...
		vc_map( array(
			"name" => __("Fancy Tab", "vp_textdomain"),
			...
			"params" => array(
				array(
					"type" => "dropdown",
					"heading" => __("Model", "vp_textdomain"),
					"param_name" => "model",
					...
					"type" => "colorpicker",
					"class" => "",
					"heading" => __("Color #1", "vp_textdomain"),
					"param_name" => "color1",
					"admin_label" => true,
					...
					"type" => "colorpicker",
					"class" => "",
					"heading" => __("Color #2", "vp_textdomain"),
					"param_name" => "color2",
					"admin_label" => true,
					"value" => "#ffffff"
				),array(
					"type" => "colorpicker",
					"class" => "",
					"heading" => __("Color #3", "vp_textdomain"),
					"param_name" => "color3",
					"admin_label" => true,
					"value" => "#000000"
				),array(
					"type" => "colorpicker",
					"class" => "",
					"heading" => __("Color #4", "vp_textdomain"),
					"param_name" => "color4",
					"admin_label" => true,
					"value" => "#34ccff"
				),
	...
	if (!function_exists('ozy_vc_fancytab')) {
		...
		vc_map( array(
			"name" => __("Fancy Tab - Item", "vp_textdomain"),
	...
	* Infinite Slider
	*/
	if(is_plugin_active("infinite-slider/infinite-slider.php")) {
		if (!function_exists('ozy_vc_infinite_slider')) {
			function ozy_vc_infinite_slider( $atts, $content = null ) {
				extract( shortcode_atts( array(
					  'title' => ''
					), $atts ) 
				);
				return do_shortcode('[infinite_slider]');
			}

			add_shortcode( 'ozy_vc_infinite_slider', 'ozy_vc_infinite_slider' );

			vc_map( array(
			   "name" => __("Infinite Slider", "vp_textdomain"),
			   "base" => "ozy_vc_infinite_slider",
			   "icon" => "icon-wpb-ozy-el",
			   'category' => 'by OZY',
			   "params" => array(
					array(
						...
						"value" => "",
						"admin_label" => true,
						"description" => __("Only a place holder", "vp_textdomain")
					)
			   )
			) );	
		}	
	...
	if (!function_exists('ozy_vc_blog_latest_posts')) {
		function ozy_vc_blog_latest_posts( $atts, $content = null ) {
			...
			while ( $loop->have_posts() ) : $loop->the_post();
				...
				$output .= '<a href="' . get_permalink() . '">' . __('Read More &rarr;', 'vp_textdomain') . '</a>' . PHP_EOL;
				$output .= '</div>' . PHP_EOL;
				$output .= '</li>' . PHP_EOL;			
			endwhile;
			wp_reset_postdata();
		...
		vc_map( array(
		   "name" => __("Latest Blog Posts", "vp_textdomain"),
		   ...
		   "params" => array(
				array(
					...
					"value" => "",
					"admin_label" => true,
					"description" => __("Component title", "vp_textdomain")
				),   
				array(
					"type" => "textfield",
					"class" => "",
					...
					"value" => "6",
					"admin_label" => false,
					"description" => __("How many post will be listed on one page?", "vp_textdomain")
				),
				array(
					"type" => "textfield",
				...
				array(
					"type" => "textfield",
					"heading" => __("Author", "vp_textdomain"),
					"param_name" => "author",
				...
				array(
					...
					"param_name" => "orderby",
					"value" => array( "", __("Date", "vp_textdomain") => "date", __("ID", "vp_textdomain") => "ID", __("Author", "vp_textdomain") => "author", __("Title", "vp_textdomain") => "title", __("Modified", "vp_textdomain") => "modified", __("Random", "vp_textdomain") => "rand", __("Comment count", "vp_textdomain") => "comment_count", __("Menu order", "vp_textdomain") => "menu_order" ),
				...
				array(
					"type" => "dropdown",
					"heading" => __("Order way", "vp_textdomain"),
					"param_name" => "order",
					"value" => array( __("Descending", "vp_textdomain") => "DESC", __("Ascending", "vp_textdomain") => "ASC" ),
					"description" => __('Designates the ascending or descending order. More at <a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>.', "vp_textdomain")
				),
				array(
					"type" => "dropdown",
					"heading" => __("Post Status", "vp_textdomain"),
					"param_name" => "post_status",
					"value" => array("publish", "pending", "draft", "auto-draft", "future", "private", "inherit", "trash", "any"),
					"admin_label" => false,
					"description" => __("Show posts associated with certain status.", "vp_textdomain")
				)
		   )
		) );	
	}
	...
	*/
	if (!function_exists('ozy_vc_spinnerlist')) {
		...
		vc_map( array(
			"name" => __("Spinner List", "vp_textdomain"),
	...
	if (!function_exists('ozy_vc_spinnerlist_item')) {
		...
		vc_map( array(
			"name" => __("Spinner List Item", "vp_textdomain"),
			...
			"params" => array(
				array(
					...
					"admin_label" => true,
					"value" => __("CLICK HERE FOR MORE INFO &gt;", "vp_textdomain")
				),array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Link", "vp_textdomain"),
	...
	*/
	if (!function_exists('ozy_vc_prettymap_multi')) {
		...
		vc_map( array(
			"name" => __("Multi Location Google Map", "vp_textdomain"),
			...
			"params" => array(
				...
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Zoom Level", "vp_textdomain"),
					"param_name" => "zoom",
					"admin_label" => true,
					"value" => "13"
				),
				array(
					"type" => "colorpicker",
					"heading" => __("Hue Color", "vp_textdomain"),
					"param_name" => "hue",
					"admin_label" => false,
					"value" => "#FF0000"
				),
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Saturation", "vp_textdomain"),
				...
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Lightness", "vp_textdomain"),
	...
	if (!function_exists('ozy_vc_prettymap_multi_location')) {
		...
		vc_map( array(
			"name" => __("Location", "vp_textdomain"),
			...
			"params" => array(
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Info Box Caption", "vp_textdomain"),
					"param_name" => "caption",
					"admin_label" => true,
					"value" => __("Head Quarter", "vp_textdomain")
				),
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Address", "vp_textdomain"),
					"param_name" => "address",
					"admin_label" => true,
					"value" => __("Melbourne, Australia", "vp_textdomain")
				),
				array(
					"type" => "attach_image",
					"class" => "",
					"heading" => __("Custom Icon", "vp_textdomain"),
					"param_name" => "custom_icon",
					"description" => __("You can select a custom icon for your pin on the map", "vp_textdomain"),
					"admin_label" => false,
					"value" => ""
				)				
		   )
	...
	*/
	if (!function_exists('ozy_vc_prettymap')) {
		...
		vc_map( array(
			"name" => __("Custom Google Map", "vp_textdomain"),
	...
	*/
	if (!function_exists('ozy_vc_simpleinfobox')) {
		...
		vc_map( array(
			"name" => __("Simple Info Box", "vp_textdomain"),
			...
			"params" => array(
				...
				array(
					...
					"param_name" => "caption",
					"admin_label" => true,
					"value" => __("Caption Over Title", "vp_textdomain")
				),				
				array(
					"type" => "textfield",
					"class" => "",
					...
					"param_name" => "title",
					"admin_label" => true,
					"value" => __("Enter Title Here", "vp_textdomain")
				),
				array(
					"type" => "textarea",
					"class" => "",
				...
				array(
					...
					"value" => __("LEARN MORE", "vp_textdomain"),
					"admin_label" => true
				),				
				array(
					"type" => "textfield",
	...
	*/
	if (!function_exists('ozy_vc_imageboxwithcaption_wrapper')) {
		...
		vc_map( array(
			"name" => __("Image Box With Caption Wrapper", "vp_textdomain"),
			...
			"params" => array(
				array(
					"type" => "dropdown",
					"class" => "",
					"heading" => __("Item Count Per Row", "vp_textdomain"),
					"param_name" => "item_count",
					"admin_label" => true,
					"value" => array("4","1","2","3")
				),
				array(
					"type" => "dropdown",
					"class" => "",
					"heading" => __("Item Spacing", "vp_textdomain"),
	...
	*/
	if (!function_exists('ozy_vc_imageboxwithcaption')) {
		...
		vc_map( array(
			"name" => __("Image Box With Caption", "vp_textdomain"),
			...
			"params" => array(
				...
				array(
					"type" => "select_an_icon",
					"heading" => __("Hover Icon", "vp_textdomain"),
					"param_name" => "icon",
					"value" => '',
					"admin_label" => false
				),			
				...
				array(
					...
					"param_name" => "tag",
					"admin_label" => true,
					"value" => __("SEE MORE", "vp_textdomain")
				),
				array(
					"type" => "textfield",
					"class" => "",
	...
	*/
	if (!function_exists('ozy_vc_coloredcontentbox')) {
		...
		vc_map( array(
			"name" => __("Coloured Content Box", "vp_textdomain"),
			...
			"params" => array(
				...
				array(
					...
					"param_name" => "caption",
					"admin_label" => true,
					"value" => __("Caption Goes Here", "vp_textdomain")
				),
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Hover Caption", "vp_textdomain"),
					"param_name" => "hover_caption",
					"admin_label" => false,
					"value" => __("SHOP NOW", "vp_textdomain")
				),			
				array(
					"type" => "colorpicker",
					"heading" => __("Foreground Color", "vp_textdomain"),
				...
				array(
					...
					"param_name" => "tag",
					"admin_label" => true,
					"value" => __("SAY SOMETHING", "vp_textdomain")
				),
				array(
					"type" => "textfield",
					"class" => "",
	...
	*/
	if (!function_exists('ozy_vc_simplehoverimagebox')) {
		...
		vc_map( array(
			"name" => __("Simple Hover Image Box", "vp_textdomain"),
			...
			"params" => array(
				...
				array(
					"type" => "colorpicker",
					"heading" => __("Main Color", "vp_textdomain"),
	...
	if (!function_exists('ozy_vc_newsbar')) {
		function ozy_vc_newsbar( $atts, $content = null ) {
			...
			while ( $the_query->have_posts() ) {
				...
				$output .= '<a href="'. get_permalink() .'">'. __('READ MORE &nbsp;&nbsp;&gt;', 'vp_textdomain') .'</a>';				
				$output .= '</li>';
			}
			wp_reset_postdata();
		...
		vc_map( array(
			"name" => __("News Bar", "vp_textdomain"),
			"base" => "ozy_vc_newsbar",
			"content_element" => true,
			"show_settings_on_create" => true,
			"icon" => "icon-wpb-ozy-el",
			...
			"params" => array(
				array(
					...
					"param_name" => "sub_title",
					"admin_label" => true,
					"value" => __("STAY TUNED", "vp_textdomain")
				),array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Link", "vp_textdomain"),
					...
					"admin_label" => true,
					"value" => '',
					"description" => __("Link to blog / news page", "vp_textdomain")
				),array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Link Caption", "vp_textdomain"),
					"param_name" => "link_caption",
					"admin_label" => true,
					"value" => __("VIEW ALL", "vp_textdomain")
				),array(
					"type" => "dropdown",
					"heading" => __("Link Target", "vp_textdomain"),
					"param_name" => "link_target",
	...
	*/
	if (!function_exists('ozy_vc_instagramcarousel')) {
		...
		vc_map( array(
			"name" => __("Instagram Carousel", "vp_textdomain"),
			...
			"params" => array(
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("User ID", "vp_textdomain"),
					"param_name" => "user",
					"admin_label" => true,
					"value" => "self",
					"description" => __('Use your own images or get User ID <a href="http://jelled.com/instagram/lookup-user-id" target="_blank">here</a>.', "vp_textdomain")
				),
				array(
					"type" => "dropdown",
	...
	if (!function_exists('ozy_vc_woocarousel')) {
		function ozy_vc_woocarousel( $atts, $content = null ) {
			...
			if(!class_exists('woocommerce')) {
				return '<div>'. __('WooCommerce Plugin is not installed or activated', 'vp_textdomain') .'</div>';
			}
				...
				if ($product->is_in_stock()) {
					...
					switch ( $handler ) {
						case "variable" :
							...
							$link['label'] = apply_filters( 'variable_add_to_cart_text', __( 'SELECT OPTIONS', 'vp_textdomain' ) );
							break;
						case "grouped" :
							$link['url'] = apply_filters( 'grouped_add_to_cart_url', get_permalink( $product->id ) );
							$link['label'] = apply_filters( 'grouped_add_to_cart_text', __( 'VIEW OPTIONS', 'vp_textdomain' ) );
							break;
						case "external" :
							$link['url'] = apply_filters( 'external_add_to_cart_url', get_permalink( $product->id ) );
							$link['label'] = apply_filters( 'external_add_to_cart_text', __( 'READ MORE', 'vp_textdomain' ) );
							break;
						default :
							if ( $product->is_purchasable() ) {
								$link['url'] = apply_filters( 'add_to_cart_url', esc_url( $product->add_to_cart_url() ) );
								$link['label'] = apply_filters( 'add_to_cart_text', __( 'ADD TO CART', 'vp_textdomain' ) );
								$link['class'] = apply_filters( 'add_to_cart_class', 'add_to_cart_button' );
							} else {
								$link['url'] = apply_filters( 'not_purchasable_url', get_permalink( $product->id ) );
								$link['label'] = apply_filters( 'not_purchasable_text', __( 'READ MORE', 'vp_textdomain' ) );
							}
						break;
					}
					...
					$output .= '<a href="'. get_permalink() .'" class="product-details">'. __('SEE PRODUCT DETAILS', 'vp_textdomain') .'</a>';
				}else{
					$output .= '<a href="' . apply_filters( 'out_of_stock_add_to_cart_url', get_permalink( $product->id ) ) .'" class="button">'. apply_filters( 'out_of_stock_add_to_cart_text', __( 'READ MORE', 'vp_textdomain' ) ) .'</a>';
				}
		...
		vc_map( array(
			"name" => __("WooCommerce Product Carousel", "vp_textdomain"),
	...
	*/
	...
	if (!function_exists('ozy_vc_owlcarousel_testimonial')) {
		...
		vc_map( array(
			"name" => __("Owl Carousel Testimonial Item", "vp_textdomain"),
			...
			"params" => array(
				array(
					"type" => "attach_image",
					"class" => "",
					"heading" => __("Carousel Background Image", "vp_textdomain"),
					"param_name" => "src",
					"admin_label" => false,
					"value" => "",
					"description" => __("Select images for your slider.", "vp_textdomain")
					...
					"type" => "attach_image",
					"class" => "",
					"heading" => __("Profile Picture", "vp_textdomain"),
					"param_name" => "profile_src",
					"admin_label" => false,
					"value" => "",
					"description" => __("Select a picture to use as profile picture of testimonial's writer.", "vp_textdomain")
				),array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Link", "vp_textdomain"),
